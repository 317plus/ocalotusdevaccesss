...
import net.mcreator.ocalotusoriginalsedition.item.ItemseapurslaneItem;
...
public class OcalotusOriginalsEditionModItems {
	...
	public static final RegistryObject<Item> ITEMSEAPURSLANE = REGISTRY.register("itemseapurslane", () -> new ItemseapurslaneItem());
